...
/// 라이트/다크 테마 전환을 지원하는 산업용 인텔리전스 UI를 구성합니다.
/// 한국어 로케일을 기본으로 지원합니다.
...
/// 글로벌 테마 모드 노티파이어
///
/// 앱 전역에서 접근 가능한 [ValueNotifier]로,
/// 라이트/다크 테마 전환 상태를 관리합니다.
final themeNotifier = ValueNotifier<ThemeMode>(ThemeMode.dark);

/// 앱의 루트 StatelessWidget
///
/// 인증 상태에 따른 라우트 리다이렉트, 라이트/다크 테마 전환,
/// 한국어 로컬라이제이션을 포함한 MaterialApp을 구성합니다.
/// [ValueListenableBuilder]를 사용하여 테마 변경을 실시간 반영합니다.
class BusanWeighingApp extends StatelessWidget {
  ...
  /// 라이트 테마 빌드
  ///
  /// Material 3 기반의 밝은 테마로, 흰색 계열 배경과
  /// 시안 주 색상을 사용합니다.
  ...
  /// 다크 테마 빌드
  ///
  /// 기존의 모던 산업 인텔리전스 다크 테마입니다.
  /// 딥 네이비 배경과 네온 시안 주 색상을 사용합니다.
