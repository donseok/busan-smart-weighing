/**
 * 시스템 설정 관리 페이지 컴포넌트 (관리자 전용)
 *
 * 시스템 운영에 필요한 각종 설정값을 카테고리별로 관리하는 페이지입니다.
 * 카테고리 탭으로 설정을 분류하고, 각 설정의 키/값/설명을 테이블로 표시합니다.
 * 설정값 인라인 편집과 저장 기능을 제공합니다.
 * 관리자 권한이 필요합니다.
 *
 * @returns 시스템 설정 관리 페이지 JSX
 */
